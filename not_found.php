...
<head>
    ...
    <title>Halaman Error | e-Money</title>
    ...
    <link rel="stylesheet" href="tema/assets/examples/css/pages/errors.css">
...
<body class="animsition page-error page-error-404 layout-full">
	...
	<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
		<div class="page-content vertical-align-middle">
			...
			<p class="error-advise">Silahkan Kembali Ke Halaman Beranda</p>
			<a class="btn btn-primary btn-round" href="index.php">Beranda</a>

			<footer class="page-copyright">
				<p>e-money © 2019. All Right Reserved.</p>
				<!-- <div class="social">
