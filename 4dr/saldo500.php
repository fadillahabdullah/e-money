...
<div class="panel">
    <header class="panel-heading">
        ...
        <h3 class="panel-title">Data Saldo</h3>
    </header>
    <div class="panel-body">
        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
            <thead>
                <tr>
                    <th style="width: 12%">ID Saldo<br>Status</th>
            ...
            <tbody>
    <?php
                    $sql = "SELECT id,nominal,keterangan FROM saldo inner join e_santri ON kd_emoney,nm_santri";
 ...
 <!--MODAL TAMBAH DATA-->
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="txtkd" placeholder="ex : 1234567890" required autocomplete="off" autofocus>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="txtkln">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="txtklh" placeholder="ex : Jombang" required autocomplete="off">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Tanggal Lahir</label>
                                <input type="date" class="form-control" name="txttlh" placeholder="ex : 01-01-2001" required autocomplete="off">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Telepon</label>
                                <input type="text" class="form-control" name="txttlp" placeholder="ex : 08********12" required autocomplete="off">
                            </div>
                            <div class="form-group col-md-12">
                                <label>Alamat</label>
                                <textarea class="form-control" name="txtalm" placeholder="ex : Dsn. Prayungan RT.03 RW.04 Kedungjati Kabuh Kab. Jombang" required autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <?php
        if (isset($_REQUEST["btntambah"])){
            ...
            $o = $_REQUEST["txtalm"];
            $q = "0";
            $SQL = "INSERT INTO e_santri VALUES ('$j','$kd','$k','$kln','$pas','$l','$m','$n','$o','$q')";
...
<!--MODAL EDIT DATA-->
                ...
                <form method="post">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>Kode e-money</label>
                                <input type="text" class="form-control" name="txtkde" id="txtkde" placeholder="ex : 8****" required>
                            </div>
    ...
    <?php
        if (isset($_REQUEST["btnedit"])){
            ...
            $n = $_REQUEST["txttlpe"];
            $o = $_REQUEST["txtalme"];
            $SQL = "UPDATE e_santri SET kd_emoney = '$kd', nm_santri = '$k', kelamin = '$kln', tmp_lahir = '$l', tgl_lahir = '$m', hp_ortu = '$n', alamat = '$o' WHERE id_santri = '$j'";
            $ProsesSimpan = mysqli_query($koneksi, $SQL);
            if ($ProsesSimpan){
                $isilog = "ID Santri = $j,\n Kode e-money = $kd,\n Nama Santri = $k,\n kelamin = $kln,\n Kelahiran = $l,\n Tanggal Lahir = $m,\n Telepon = $n,\n Alamat = $o";
 ...
 <!--MODAL AKTIFKAN-->
    ...
    function hapus(a, b, c, d, e, f,g,h){
        $("#txtidh").val(a);
        $("#txtkdh").val(b);
        $("#txtnamah").val(c);
        $("#txtklmh").val(d);
