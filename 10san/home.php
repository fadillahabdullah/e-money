...
<?php
    ...
    if ($folder != "9we"){echo "<script>window.location = '../index.php';</script>";}
?>
<!DOCTYPE html>
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <title>Dashboard | e-POS</title>
        <link rel="apple-touch-icon" href="../tema/assets/images/apple-touch-icon.png">
        <link rel="shortcut icon" href="../tema/assets/images/e-pos2.png">
    ...
    <body class="animsition dashboard">
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-teal-600" role="navigation">
            <div class="navbar-header">
                ...
                <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
                    <img class="navbar-brand-logo" src="../tema/assets/images/e-pos.png" title="e-POS">
                    <span class="navbar-brand-text hidden-xs-down"> e-POS</span>
                </div>
            </div>
            ...
            <div class="navbar-container container-fluid">
                <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                    ...
                    <div class="navbar-brand navbar-brand-center">
                        <a href="Beranda">
                            <img class="navbar-brand-logo navbar-brand-logo-normal" src="../tema/assets/images/e-pos3.png" title="e-POS">
                            <img class="navbar-brand-logo navbar-brand-logo-special" src="../tema/assets/images/e-pos3.png" title="e-POS">
                        </a>
                    </div>
                </div>
                <!-- End Navbar Collapse -->
        ...
        <div class="site-menubar">
            <div class="site-menubar-header">
                <div class="cover overlay">
                    <img class="cover-image" src="../tema/assets/examples/images/dashboard-header.jpg" alt="tema.">
						...
						<ul class="site-menu" data-plugin="menu">
                            ...
                            <li class="site-menu-item has-sub">
                                ...
                                <ul class="site-menu-sub">
                                    ...
                                    <li class="site-menu-item">
                                        <a class="animsition-link" href="BarangMasuk">
                            ...
                            <li class="site-menu-item has-sub">
                                <a href="javascript:void(0)">
                                    <i class="site-menu-icon ti-settings" aria-hidden="true"></i>
                                ...
                                <!--<ul class="site-menu-sub">
                                    <li class="site-menu-item has-sub">
                                        ...
                                        <!--<ul class="site-menu-sub">
                                            ...
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="Gudang">
                                                    <span class="site-menu-title">Admin Gudang</span>
                                                </a>
                                            </li>
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="Sales">
                                                    <span class="site-menu-title">Salesman</span>
                                                </a>
                                            </li>
                                        </ul>-->
                                    </li>
                                    <!-- <li class="site-menu-item has-sub">
                                        <a href="javascript:void(0)">
                                            <span class="site-menu-title">Rekening</span>
                                            <span class="site-menu-arrow"></span>
                                        </a>
                                        <ul class="site-menu-sub">
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="AturRekInduk">
                                                    <span class="site-menu-title">Induk</span>
                                                </a>
                                            </li>
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="AturRekSubInduk">
                                                    <span class="site-menu-title">Sub Induk</span>
                                                </a>
                                            </li>
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="AturRekProgram">
                                                    <span class="site-menu-title">Program</span>
                                                </a>
                                            </li>
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="AturRekKegiatan">
                                                    <span class="site-menu-title">Kegiatan</span>
                                                </a>
                                            </li>
                                            <li class="site-menu-item">
                                                <a class="animsition-link" href="AturRekKegiatanDetail">
                                                    <span class="site-menu-title">Kegiatan Detail</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li> -->
                            ...
                            <!-- <li class="site-menu-item">
                                <a class="animsition-link" href="LapAnggaran">
                                    <i class="site-menu-icon ti-printer" aria-hidden="true"></i>
                                    <span class="site-menu-title">Laporan Anggaran</span>
                                </a>
                            </li> -->
						</ul>      
					</div>
        ...
        <footer class="site-footer">
            <div class="site-footer-legal">© 2018 <a href="http://themeforest.net/item/remark-responsive-bootstrap-admin-template/11989202">e-POS</a></div>
            <div class="site-footer-right">
                Powered By <i class="red-600 icon ti-gift"></i> <a href="https://themeforest.net/user/creation-studio">CreationStudio</a>
            </div>
        </footer>
